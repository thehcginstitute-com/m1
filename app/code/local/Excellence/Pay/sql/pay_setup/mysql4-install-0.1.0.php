...
ALTER TABLE `{$installer->getTable('sales/quote_payment')}` ADD `account_holder_name` VARCHAR( 255 ) NOT NULL ;

ALTER TABLE `{$installer->getTable('sales/order_payment')}` ADD `bank_name` VARCHAR( 255 ) NOT NULL ;
ALTER TABLE `{$installer->getTable('sales/order_payment')}` ADD `account_holder_name` VARCHAR( 255 ) NOT NULL ;
