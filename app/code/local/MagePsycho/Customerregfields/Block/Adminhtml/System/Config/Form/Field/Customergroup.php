 ...
 */
class MagePsycho_Customerregfields_Block_Adminhtml_System_Config_Form_Field_Customergroup extends Mage_Core_Block_Html_Select
{
    /**
    ...
    protected function _getCustomerGroups($groupId = null)
    {
        if (is_null($this->_customerGroups)) {
            ...
            $collection->setOrder('customer_group_code', Varien_Data_Collection::SORT_ORDER_ASC);
