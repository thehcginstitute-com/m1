 ...
 */
class MagePsycho_Loginredirectpro_Block_System_Config_Grouplogoutredirect extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
	/**
	...
	protected function _prepareToRender()
	{
		...
		$this->addColumn('logout_redirect', array(
				'label' => Mage::helper('magepsycho_loginredirectpro')->__('Logout Redirection Url'),
				//'style' => 'width:100px',
		));
