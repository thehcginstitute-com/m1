 ...
 */
class MagePsycho_Loginredirectpro_Block_System_Config_Grouploginredirect extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
	/**
	...
	protected function _prepareToRender()
	{
		...
		$this->addColumn('login_redirect', array(
				'label' => Mage::helper('magepsycho_loginredirectpro')->__('Login Redirection Url'),
				//'style' => 'width:100px',
		));
