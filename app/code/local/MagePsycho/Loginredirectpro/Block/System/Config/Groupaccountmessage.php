 ...
 */
class MagePsycho_Loginredirectpro_Block_System_Config_Groupaccountmessage extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
	/**
	...
	protected function _prepareToRender()
	{
		...
		$this->addColumn('account_message', array(
				'label' => Mage::helper('magepsycho_loginredirectpro')->__('New Account Success Message'),
				//'style' => 'width:100px',
		));
		$this->_addAfter = false;
		$this->_addButtonLabel = Mage::helper('magepsycho_loginredirectpro')->__('Add Success Message');
	}
