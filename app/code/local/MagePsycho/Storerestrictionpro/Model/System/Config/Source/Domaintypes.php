 ...
 */
class MagePsycho_Storerestrictionpro_Model_System_Config_Source_Domaintypes
{
        ...
        if (is_null($this->_options)) {
            $this->_options = array(
                array(
                    ...
                    'label' => Mage::helper('magepsycho_storerestrictionpro')->__('Production'),
                ),

                array(
                    'value' => self::DOMAIN_TYPE_DEVELOPMENT,
                    'label' => Mage::helper('magepsycho_storerestrictionpro')->__('Development'),
                ),
            );
