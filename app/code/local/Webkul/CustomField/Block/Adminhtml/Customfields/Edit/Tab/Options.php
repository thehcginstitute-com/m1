 ...
 */ 
class Webkul_CustomField_Block_Adminhtml_Customfields_Edit_Tab_Options extends Mage_Adminhtml_Block_Widget
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('customfield/getoptions.phtml');
    }
    ...
    {
        return Mage::registry('dependable_field_option');
    }
}