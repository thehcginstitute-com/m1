...
class Mage_Rule_Model_Condition_Combine extends Mage_Rule_Model_Condition_Abstract
{
     ...
     * @return $this
     */
    function loadAggregatorOptions()
    {
     ...
     * @return array
     */
    function getAggregatorSelectOptions()
    {
        $opt = [];
