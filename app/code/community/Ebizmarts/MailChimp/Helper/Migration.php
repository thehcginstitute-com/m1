            ...
            if ($attribute->getId()) {
                ...
                $this->_makeForCollectionItem(
                    ...
                    function ($customer, $mailchimpStoreId) {
                        ...
                        $syncError = null;
                        $syncModified = null;
                        $syncDelta = $customerObject['mailchimp_sync_delta'];

                        if ($customer['mailchimp_sync_error']) {
                            $syncError = $customer['mailchimp_sync_error'];
                        }
            ...
            if (isset($orderFields['mailchimp_sync_delta'])) {
                ...
                $this->_makeForCollectionItem(
                    ...
                    function ($order, $mailchimpStoreId) {
                        ...
                        if ($order['mailchimp_sync_error']) {
                            $syncError = $order['mailchimp_sync_error'];
                        }
            ...
            if (isset($quoteFields['mailchimp_sync_delta'])) {
                ...
                $finished = $this->_makeForCollectionItem(
                    ...
                    function ($quote, $mailchimpStoreId) {
                        ...
                        $syncDelta = $quoteObject['mailchimp_sync_delta'];

                        if ($quote['mailchimp_sync_error']) {
                            $syncError = $quote['mailchimp_sync_error'];
                        }
