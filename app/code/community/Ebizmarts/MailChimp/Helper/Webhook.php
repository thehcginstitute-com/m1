    ...
    protected function deleteCurrentWebhook($scopeId, $scope, $listId) {
        ...
        try {
            ...
            if ($webhookId && $apiKey && $listId) {
                ...
                $helper->getConfig()->deleteConfig(Ebizmarts_MailChimp_Model_Config::GENERAL_WEBHOOK_ID, $scope, $scopeId);
            } else {
        ...
        try {
            ...
            try {
                ...
                if ($createWebhook) {
                    ...
                    hcg_mc_cfg_save(Ebizmarts_MailChimp_Model_Config::GENERAL_WEBHOOK_ID, $newWebhookId, $scopeId, $scope);
