	...
	public function getAllReviews(){
		...
		foreach($_reviews as $review):
			...
			if($enable_product_image == "1"):
				...
				$data['reviews'][$i]['product_image'] = '<a href="'.$_product->getProductUrl().'" title="'.$data['reviews'][$i]['price'].'" class="product-image"><img src="'.$this->helper('catalog/image')->init($_product, 'small_image')->resize(80).'" width="80" height="80" alt="'.$this->stripTags($this->getImageLabel($_product, 'small_image'), null, true).'" /></a>';
