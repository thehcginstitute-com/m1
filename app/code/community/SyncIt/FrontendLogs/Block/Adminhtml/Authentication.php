...
class SyncIt_FrontendLogs_Block_Adminhtml_Authentication extends Mage_Adminhtml_Block_Widget_Grid_Container{

	public function __construct() {
	$this->_controller = "adminhtml_authentication";
	$this->_blockGroup = "frontendlogs";
	$this->_headerText = Mage::helper("frontendlogs")->__("Frontend Logs Manager");
	$this->_addButtonLabel = Mage::helper("frontendlogs")->__("Add New Item");
	parent::__construct();
