...
/**
 * Class IWD_OrderFlags_Block_System_Config_Form_Fieldset_Extensions
 */
class IWD_OrderFlags_Block_System_Config_Form_Fieldset_Extensions extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
     * {@inheritdoc}
     */
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        if ($available) {
            ...
            return sprintf(
                '<span class="error">%s<br />%s<br />%s<br /> <a href="http://www.iwdextensions.com" target="_blank">www.iwdextensions.com</a></span>',
                $version,
