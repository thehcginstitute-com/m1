...
class IWD_MultiInventory_Block_Adminhtml_Order_Render_Inventory
    extends IWD_MultiInventory_Block_Adminhtml_Order_Render_Abstract
{
    protected $_orderId;
    protected $_itemId;
    ...
    {
        $row = Mage::getModel('iwd_multiinventory/cataloginventory_stock_order')->getStockOrderData($orderId);
    ...
    protected function getStockMessage($jsAction = "IWD.MultiInventory.Stock.showAssignStockForm")
    {
    ...
    {
        $title = Mage::helper('iwd_multiinventory')->__($title);
    ...
    public function getStockMessageForOrderItem($orderItem)
    {
        ...
        $row = Mage::getModel('iwd_multiinventory/cataloginventory_stock_order')->getStockOrderData($this->_orderId);
        $this->isStockAssigned = $row["assigned"];

        $this->qtyAssigned = Mage::getModel('iwd_multiinventory/cataloginventory_stock_order_item')
            ->getOrderItemQtyAssigned($this->_itemId);

        return $this->getStockMessage("IWD.MultiInventory.Stock.Order.showAssignStockForm");
    }
}