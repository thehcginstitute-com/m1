...
/**
 * Class IWD_MultiInventory_Block_Adminhtml_Cataloginventory_Product_Grid
 */
class IWD_MultiInventory_Block_Adminhtml_Cataloginventory_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        foreach ($stocks as $stock) {
            ...
            $this->addColumn('qty' . $id, array(
                ...
                'editable' => true,
                'sortable' => true,
                'renderer'=>'IWD_MultiInventory_Block_Adminhtml_Cataloginventory_Product_Grid_Renderer_Qty'
            ));
        }
