...
class IWD_MultiInventory_Block_Adminhtml_Cataloginventory_Stock_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('iwd_multiinventory')->__('Save Source'));
    ...
    public function getHeaderText()
    {
        if ($this->isEdit()) {
            ...
            return Mage::helper('iwd_multiinventory')
                ->__("Edit Source '%s' (ID: %s)", $stockData->getStockName(), $stockData->getStockId());
        }

        return Mage::helper('iwd_multiinventory')->__('Add New Source');
    }
