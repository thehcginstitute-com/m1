...
class IWD_MultiInventory_Block_Adminhtml_Cataloginventory_Stock_Edit_Tab_General
    extends IWD_MultiInventory_Block_Adminhtml_Cataloginventory_Stock_Edit_Tab_Abstract
{
    protected function addFieldsetToForm()
    {
        $helper = Mage::helper('iwd_multiinventory');

        $fieldsetGeneralInfo = $this->form->addFieldset('iwd_multiinventory_stock_general', array(
