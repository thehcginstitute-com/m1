...
/**
 * Class IWD_MultiInventory_Block_Adminhtml_Cataloginventory_Order_Stock
 */
class IWD_MultiInventory_Block_Adminhtml_Cataloginventory_Order_Stock extends Mage_Adminhtml_Block_Widget
{
    ...
    {
        parent::__construct();
        $this->setTemplate('iwd/multiinventory/cataloginventory/order/stock.phtml');
    }
