...
class IWD_MultiInventory_Block_Adminhtml_Cataloginventory_Stock_Edit_Tab_Address extends IWD_MultiInventory_Block_Adminhtml_Cataloginventory_Stock_Edit_Tab_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('iwd/multiinventory/cataloginventory/stock/edit/tab/address.phtml');
    }
