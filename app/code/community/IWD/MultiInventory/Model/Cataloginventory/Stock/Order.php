...
/**
 * Class IWD_MultiInventory_Model_Cataloginventory_Stock_Order
 */
class IWD_MultiInventory_Model_Cataloginventory_Stock_Order extends Mage_Core_Model_Abstract
{
    /**
     * @param $orderId
    ...
    public function updateStockOrder($orderId, $qtyAssigned = 0, $qtyOrdered = null)
    {
        ...
        $qtyOrdered = ($qtyOrdered === null) ? $this->getQtyOrdered($orderId) : $qtyOrdered;
