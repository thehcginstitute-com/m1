...
/**
 * Class IWD_MultiInventory_Model_Cataloginventory_Stock_Item
 */
class IWD_MultiInventory_Model_Cataloginventory_Stock_Item extends Mage_CatalogInventory_Model_Stock_Item
{
    /**
     * @return int
     */
