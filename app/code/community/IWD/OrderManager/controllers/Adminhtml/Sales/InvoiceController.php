        ...
        if (Mage::getModel('iwd_ordermanager/invoice')->isAllowDeleteInvoices()) {
            ...
            try {
                foreach ($checkedInvoices as $invoiceId) {
                    /**
                     * @var $invoiceModel IWD_OrderManager_Model_Invoice
                     */
                    $invoiceModel = Mage::getModel('iwd_ordermanager/invoice');
                    ...
                    if ($invoice->getId()) {
                        ...
                        $invoiceModel->deleteFromGrid($invoiceId);
                        Mage::getSingleton('iwd_ordermanager/logger')->itemDeleteSuccess('invoice', $invoiceId);
                    }
                }
