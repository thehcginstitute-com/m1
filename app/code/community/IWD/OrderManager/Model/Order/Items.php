...
class IWD_OrderManager_Model_Order_Items extends Mage_Sales_Model_Order_Item
{
    ...
    function updateOrderItems(array $params):void {
        $this->init($params);
	 ...
	 */
    private function editItems():bool {
		 ...
		 *	}
		 */
		$r = $orderEdit->editItems((int)dfa($this->params, 'order_id'), dfa($this->params, 'items')); /** @var bool $r */
