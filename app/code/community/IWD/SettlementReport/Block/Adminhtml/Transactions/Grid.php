...
/**
 * Class IWD_SettlementReport_Block_Adminhtml_Transactions_Grid
 */
class IWD_SettlementReport_Block_Adminhtml_Transactions_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * @var string
     */
    ...
    {
        $collection = Mage::getModel('iwd_settlementreport/transactions')->getTransactionsCollection();
        $this->setCollection($collection);

        $this->addFiltersToCollection();

        $exportForEmail = $this->getData('export_for_email');
        if (Mage::helper('iwd_settlementreport')->isGridExport() || (isset($exportForEmail) && !empty($exportForEmail))) {
            return $this;
        }
    ...
    {
        $exportForEmail = $this->getData('export_for_email');
        if (isset($exportForEmail) && !empty($exportForEmail)) {
    ...
    {
        $gridFilter = Mage::getSingleton('adminhtml/session')->getData("iwd_settlementreport_transactions_gridfilter");
        $filter = Mage::helper('adminhtml')->prepareFilterString($gridFilter);
        ...
        $this->createdAtFrom = $filter['created_at']['from'];
        $this->createdAtTo = $filter['created_at']['to'];
        ...
        Mage::getSingleton('adminhtml/session')->setData("iwd_settlementreport_filter_from", $this->createdAtFrom);
        Mage::getSingleton('adminhtml/session')->setData("iwd_settlementreport_filter_to", $this->createdAtTo);
    }
    ...
    {
        $lastDays = Mage::getStoreConfig('iwd_settlementreport/default/last_days');
        return !empty($lastDays) ? $lastDays : 7;
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('transaction_id', array(
            ...
            'width' => '50px',
            'sortable' => true,
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Transaction(array('export' => $export)),
        ));
        ...
        $this->addColumn('order_increment_id', array(
            ...
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Order(array('export' => $export)),
        ));
        ...
        $this->addColumn('status', array(
            ...
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Status(array('export' => $export)),
        ));
        ...
        $this->addColumn('mage_transaction_status', array(
            ...
            'align' => 'right',
            'width' => '100px',
            'options' => Mage::getSingleton('iwd_settlementreport/adminhtml_options_status')->toOptionArrayMage(),
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Colorize_Status(array('export' => $export)),
        ));
        ...
        $this->addColumn('auth_transaction_status', array(
            ...
            'align' => 'right',
            'width' => '100px',
            'options' => Mage::getSingleton('iwd_settlementreport/adminhtml_options_status')->toOptionArrayAuth(),
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Colorize_Status(array('export' => $export)),
        ));
        ...
        $this->addColumn('mage_amount_authorized', array(
            ...
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Colorize_Amount(array('for_compare_coll' => 'auth_amount_authorized', 'export' => $export)),
        ));
        ...
        $this->addColumn('auth_amount_authorized', array(
            ...
            'currency' => 'base_currency_code',
            'currency_code' => $currencyCode,
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Colorize_Amount(array('for_compare_coll' => 'mage_amount_authorized', 'export' => $export)),
        ));
        ...
        $this->addColumn('mage_amount_captured', array(
            ...
            'currency' => 'base_currency_code',
            'currency_code' => $currencyCode,
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Colorize_Amount(array('for_compare_coll' => 'auth_amount_captured', 'export' => $export)),
        ));
        ...
        $this->addColumn('auth_amount_captured', array(
            ...
            'currency' => 'base_currency_code',
            'currency_code' => $currencyCode,
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Colorize_Amount(array('for_compare_coll' => 'mage_amount_captured', 'export' => $export)),
        ));
        ...
        $this->addColumn('mage_amount_settlement', array(
            ...
            'currency' => 'base_currency_code',
            'currency_code' => $currencyCode,
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Colorize_Amount(array('for_compare_coll' => 'auth_amount_settlement', 'export' => $export)),
        ));
        ...
        $this->addColumn('auth_amount_settlement', array(
            ...
            'currency' => 'base_currency_code',
            'currency_code' => $currencyCode,
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Colorize_Amount(array('for_compare_coll' => 'mage_amount_settlement', 'export' => $export)),
        ));
        ...
        $this->addColumn('mage_amount_refund', array(
            ...
            'currency' => 'base_currency_code',
            'currency_code' => $currencyCode,
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Colorize_Amount(array('for_compare_coll' => 'auth_amount_refund', 'export' => $export)),
        ));
        ...
        $this->addColumn('auth_amount_refund', array(
            ...
            'currency' => 'base_currency_code',
            'currency_code' => $currencyCode,
            'renderer' => new IWD_SettlementReport_Block_Adminhtml_Transactions_Renderer_Colorize_Amount(array('for_compare_coll' => 'mage_amount_refund', 'export' => $export)),
        ));
    ...
    public function addJs()
    {
        ...
        $notifyForm = sprintf(
            "<td id='send_email_with_report'><span><img src='%s' alt=' ' class='v-middle'/>&nbsp;%s&nbsp;</span><input value='%s' id='emails'/>&nbsp;<button id='report_send_button' title='%s' type='button' class='scalable task' onclick='sendReportsViaEmail()'><span><span><span>%s</span></span></span></button>",
        ...
        return
            ...
            function sendReportsViaEmail(){
                ...
                if(email.length > 5){
                    ...
                    alert("' . Mage::helper('iwd_settlementreport')->__('Please, enter email(s)') . '");
                }
            }
            ...
            {
                $ji("' . $notifyForm . '").insertAfter("#iwd_settlementreport_transactions_grid .actions tbody .pager");
            }
        </script>';
    }
}
