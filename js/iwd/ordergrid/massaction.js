...
IWD.OrderMassaction = {
    ...
    generateActionsList: function() {
        ...
        actionsList += '</ul><div class="actions">' +
            '<button type="button" onclick="IWD.OrderMassaction.openCloseActionsList()">Cancel</button>' +
            '<button type="button" onclick="IWD.OrderMassaction.updateActionListState()">Update</button>' +
