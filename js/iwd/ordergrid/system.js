...
IWD.OrderManager.Settings = {
    ...
    initMultiselect: function() {
        $ji("#iwd_ordergrid_grid_order_columns").multiselect();
        $ji("#iwd_ordergrid_customer_orders_orders_grid_columns").multiselect();
        $ji("#iwd_ordergrid_customer_orders_resent_orders_grid_columns").multiselect();
    },
    ...
    initColumnsWidth: function() {
        ...
        $ji(document).on('change', '.ui-multiselect .col-width', function() {
            ...
            $ji('#iwd_ordergrid_grid_order_columns_width').val(JSON.stringify(columnsWidth));
        });
    ...
    readColumnsWidth: function () {
        var columnsWidth = $ji('#iwd_ordergrid_grid_order_columns_width').val();
        try {
    ...
    initStatusColor: function() {
        ...
        if ($ji("#iwd_ordergrid_grid_order_status_color").length > 0) {
            ...
            $ji('.color-box').on('click',function () {
                ...
                onSubmit: function (hsb, hex, rgb, el) {
                    ...
                    $ji("#iwd_ordergrid_grid_order_status_color").val(colorsString);
                }
            });
    ...
    initColorsArray: function() {
        var self = this;
        var colorsString = $ji("#iwd_ordergrid_grid_order_status_color").val();
